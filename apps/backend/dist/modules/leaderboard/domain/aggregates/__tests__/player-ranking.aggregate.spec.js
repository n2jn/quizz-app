...
const player_ranking_aggregate_1 = require("../player-ranking.aggregate");
describe('PlayerRanking Aggregate', () => {
    const rankingId = 'ranking-123';
    const userId = 'user-123';
    describe('create', () => {
        it('should create ranking with initial values', () => {
            const ranking = player_ranking_aggregate_1.PlayerRanking.create(rankingId, userId);
...
//# sourceMappingURL=player-ranking.aggregate.spec.js.map