...
const get_leaderboard_query_1 = require("../../application/queries/get-leaderboard.query");
let LeaderboardController = class LeaderboardController {
    constructor(queryBus) {
        this.queryBus = queryBus;
    }
    async getLeaderboard(type = 'global', limit = 100) {
        return this.queryBus.execute(new get_leaderboard_query_1.GetLeaderboardQuery(type, limit));
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'type', enum: ['global', 'weekly'], required: false }),
