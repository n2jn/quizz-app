...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'answer-uuid', description: 'Selected answer ID' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], SubmitAnswerDto.prototype, "answerId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 3500, description: 'Time spent answering in milliseconds' }),
