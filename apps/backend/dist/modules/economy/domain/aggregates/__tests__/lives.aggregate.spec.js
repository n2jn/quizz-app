...
const lives_aggregate_1 = require("../lives.aggregate");
describe('Lives Aggregate', () => {
    const livesId = 'lives-123';
    const userId = 'user-123';
    describe('create', () => {
        it('should create lives with max lives', () => {
            const lives = lives_aggregate_1.Lives.create(livesId, userId);
        ...
        it('should accept custom max lives', () => {
            const lives = lives_aggregate_1.Lives.create(livesId, userId, 10);
...
//# sourceMappingURL=lives.aggregate.spec.js.map