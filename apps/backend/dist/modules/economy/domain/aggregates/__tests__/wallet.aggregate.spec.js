...
const wallet_aggregate_1 = require("../wallet.aggregate");
describe('Wallet Aggregate', () => {
    const walletId = 'wallet-123';
    const userId = 'user-123';
    describe('create', () => {
        it('should create wallet with zero balance', () => {
            const wallet = wallet_aggregate_1.Wallet.create(walletId, userId);
...
//# sourceMappingURL=wallet.aggregate.spec.js.map