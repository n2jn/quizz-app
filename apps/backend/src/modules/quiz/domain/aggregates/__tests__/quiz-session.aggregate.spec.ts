import { QuizSession, SessionStatus } from '../quiz-session.aggregate';
...
describe('QuizSession Aggregate', () => {
  ...
  describe('create', () => {
    it('should create session with valid data', () => {
      const session = QuizSession.create(sessionId, userId, categoryId, difficultyId, sessionDuration);
    ...
    it('should accept null category', () => {
      const session = QuizSession.create(sessionId, userId, null, difficultyId, sessionDuration);
